...
<?php                                
                                ...
                                $ChurchList = $objChurchList->dbFetchArray();     ?>
        ...
        <div class="col-12">
          ...
          <div class="row">
                          ...
                          <div class="btn-group m-t-15">
                                   ...
                                   <a href="<?php echo Route::_('show=staffmembering');?>" class="btn btn-default waves-effect waves-light">Add New Staff Member</a>
                          ...
                          <div class="btn-group m-t-15">
                                   ...
                                   <a href="<?php echo Route::_('show=contributing');?>" class="btn btn-default waves-effect waves-light">Add New Contribution</a>
                    ...
                    <!--      <div class="col-sm-10">-->
                          ...
                          <div class="btn-group m-t-15">
                                   ...
                                   <a href="<?php echo Route::_('show=expensing');?>" class="btn btn-default waves-effect waves-light">Add New Expense</a>
            ...
            <div class="row">
              ...
              <!--    <input type="hidden" id="church_id" name="church_id" value="<?php echo $church_id;?>" />-->
                  ...
                  <input type="hidden" id="member_id" name="member_id" value="<?php echo $ChurchList["member_id"];?>" />
