                  ...
                  <input type="hidden" id="mode" name="mode" value="<?php echo $mode;?>" />
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" name="church_name" value="<?php echo $church_name;?>" placeholder="Type Church Name..." required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" value="<?php echo $church_address;?>" name="church_address" placeholder="Church Location..." required>
