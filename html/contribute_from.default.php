...
$objCurrencyList->setProperty("transection_type", 1);
...
$objContTypeList->setProperty("tran_type", 1);
    ...
    <div class="container-fluid"> 
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <h4 class="page-title">Contribution Form</h4>

          <ol class="breadcrumb">

            <li class="breadcrumb-item"><a href="<?php echo SITE_URL;?>">Home</a></li>

            <li class="breadcrumb-item active">Contribution  Form</li>
      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="card-box">
            ...
            <h4 class="m-t-0 header-title"><b>Contribution Form</b></h4>
              ...
              <div class="col-12">
                ...
                <div class="p-20">
                  ...
                  <?php } elseif($CountContTypeList == 0){ ?>
					  ...
					  <p style="color:#F00; text-align:center"><strong>Receiving Fund Category Required</strong><br />

                  We didn't find any Receiving Fund Category... <br /><a href="<?php echo Route::_('show=contcatlist');?>">Click here to add new Receiving Fund Category.</a>
