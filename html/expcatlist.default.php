                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row">
                          ...
                          <div class="btn-group pull-right m-t-15">
                                   <a href="<?php echo Route::_('show=expcat_form');?>" class="btn btn-default waves-effect waves-light">Add New Category</a>
                                </div>
                      ...
                      <div class="row">
                          <div class="col-12">
                              <div class="card-box table-responsive">
								...
								$objContCatList->setProperty("tran_type", 2);
                                ...
                                ?>
                                      ...
                                      <td align="center"><?php echo CategoryStatus($ContCatList["is_active"]);?></td>
                                       <td align="center">
                                       <a href="<?php echo Route::_('show=expcat_form&tci='.EncData($ContCatList["tran_category_id"]));?>">
                                       <i class="fa fa-pencil"></i></a>
                                       
                                        &nbsp;&nbsp;  | &nbsp;&nbsp;
                  <a href="<?php echo Route::_('show=expcatlist&mode=delete&tci='.EncData($ContCatList["tran_category_id"]));?>">
