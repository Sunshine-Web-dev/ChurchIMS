                  ...
                  <input type="hidden" id="mode" name="mode" value="<?php echo $mode;?>" />
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" name="member_no" value="<?php echo $data['member_no'];?>" placeholder="Type Member Number..." required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data['collection_date'];?>" name="collection_date" placeholder="Type Date... Day/Month/Year" required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data['check_no'];?>" name="check_no" placeholder="Type Check Number...">
                     ...
                     <label class="col-2 col-form-label">Currency Paid Type</label>
                      ...
                      <select class="form-control" maxlength="25" name="is_active" id="is_active">
                        ...
                        <option value="<?php echo $ChurchList["currency_name"];?>" placeholder="Type Currency Category..."></option>
                  ...
                  <div class="form-group row">
                     ...
                     <label class="col-2 col-form-label">Expense Category</label>
                      ...
                      <select class="form-control" maxlength="25" name="is_active" id="is_active">
                        ...
                        <option value="<?php echo $ChurchList["tran_category_name"];?>" placeholder="Type Category..."></option>
                    ...
                    <?php } ?>
                     ...
                     <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data['receiving_amount'];?>" name="receiving_amount" placeholder="Type Amount...">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data['transection_note'];?>" name="transection_note" placeholder="Type Expense Note...">
                    ...
                    <div class="form-group row">
                     ...
                     <label class="col-2 col-form-label">Status Type</label>
                      ...
                      <select class="form-control" maxlength="25" name="is_active" id="is_active">
                        ...
                        <option value="1" <?php echo $data['is_active'];?><?php if($is_active==1){ echo 'selected="selected"';} else { echo '';}?>>Active</option>
