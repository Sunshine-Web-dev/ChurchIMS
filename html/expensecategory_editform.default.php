                  ...
                  <input type="hidden" id="mode" name="mode" value="<?php echo $mode;?>" />
                     ...
                     <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" value="<?php print_r($_POST[$tran_category_id]); echo $data['tran_category_name'];?>" name="tran_category_name" placeholder="Type Category ...">
                     ...
                     <label class="col-2 col-form-label">Status Type</label>
                      ...
                      <select class="form-control" maxlength="25" name="is_active" id="is_active">
                        ...
                        <option value="1" <?php echo $is_active ;?> <?php if($is_active==1){ echo 'selected="selected"';} else { echo '';}?>>Active</option>
