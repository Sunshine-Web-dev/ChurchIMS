...
<div class="content-page"> 
  ...
  <div class="content">
    <div class="container-fluid"> 
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="btn-group pull-right m-t-15"> <a href="<?php echo Route::_('show=expense_from');?>" class="btn btn-default waves-effect waves-light">Add New Expense</a> </div>
          ...
          <div class="card-box table-responsive">
            ...
            <table id="datatable" class="table table-bordered">
              ...
              <tbody>
                    ...
                    $objContList->setProperty("transection_type", 2);
                    ...
                    ?>
                <tr>
                  <td><a href="<?php echo Route::_('show=expdetail&ti='.EncData($ContList["transection_id"]));?>">
                  ...
                  <td align="center">
                  <a href="<?php echo Route::_('show=expense_from&ti='.EncData($ContList["transection_id"]));?>">
                  <i class="fa fa-pencil"></i></a>
                  &nbsp;&nbsp;  | &nbsp;&nbsp;
                  <a href="<?php echo Route::_('show=expensing&mode=delete&ti='.EncData($ContList["transection_id"]));?>">
