                ...
                <div class="p-20">
                  ...
                  <input type="hidden" id="mode" name="mode" value="<?php echo $mode;?>" />
                    ...
                    <div class="form-group row">
                      ...
                      <label class="col-2 col-form-label">Member Name</label>

                      <div class="col-10">

                        <input type="text" class="form-control" name="church_name" value="<?php echo $church_name;?>" placeholder="Type Member Name..." required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" value="<?php echo $church_address;?>" name="church_address" placeholder="Member Location..." required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" value="<?php echo $church_city;?>" name="church_city" placeholder="Member Address...">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" class="form-control" value="<?php echo $church_m_number;?>" name="church_m_number" placeholder="Member Mobile#">
