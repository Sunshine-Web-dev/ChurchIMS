<?php include_once(ACTION_PATH . 'staff_dataquery.php');
    ...
    <div class="container-fluid"> 
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <h4 class="page-title">Staff Member Data</h4>
      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="card-box">
            ...
            <h4 class="m-t-0 header-title"><b>Staff Member Data Form</b></h4>
            ...
            <div class="row">
              ...
              <div class="col-12">
                ...
                <div class="p-20">
                  ...
                  <input type="hidden" id="member_type" name="member_type" value="3" />
                  ...
                  <input type="hidden" id="mode" name="mode" value="<?php echo $mode;?>" />
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="password" class="form-control" value="<?php echo $member_pass;?>" name="member_pass" placeholder="Type Password...">
                   ...
                   <div class="form-group row">
                      ...
                      <label class="col-2 col-form-label">Member Category</label>
                      ...
                      <div class="col-10">
                        ...
                        <option value="<?php echo $StaffCategory["member_category_id"];?>"

                        <?php if($member_category_id==$StaffCategory["member_category_id"]){
                        ...
                        ><?php echo $StaffCategory["category_name"];?></option>
                    ...
                    <div class="form-group row">
                     ...
                     <label class="col-2 col-form-label">Login Permission</label>

                      <div class="col-10">

                      <select class="form-control" maxlength="25" name="login_permission" id="login_permission">

                        <option value="1" <?php if($login_permission==1){ echo 'selected="selected"';} else { echo '';}?>>Yes</option>

                        <option value="2" <?php if($login_permission==2){ echo 'selected="selected"';} else { echo '';}?>>No</option>
