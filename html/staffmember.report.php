          ...
          <div class="col-sm-12">
            <div class="card-box">
              ...
              <form action="" method="post" id="frmGenFilt" name="frmGenFilt">
                ...
                <div class="row">
                  <div class="col-md-6">
                      <h5><b>Select List of Church </b></h5>
                      <select class="form-control" maxlength="25" name="chlst" id="church_status">
                        <option value="0">All</option>
						<?php 
                        $objChurchList = new Member;
                        $objChurchList->setProperty("ORDERBY", "church_name");
                        $objChurchList->lstChurch();
						while($ChurchList = $objChurchList->dbFetchArray(1)){
                        ?>
                        <option value="<?php echo $ChurchList["church_id"];?>" <?php if($_POST["chlst"]==$ChurchList["church_id"]){ echo 'selected="selected"';} else { echo '';}?>><?php echo $ChurchList["church_name"];?></option>
                        <?php } ?>
                      </select>
                  </div>
                  <div class="col-md-6">
              ...
              <tbody>
                <?php
                                ...
                                while($StaffMember = $objStaffMember->dbFetchArray(1)){
									$objChurchName->setProperty("church_id", $StaffMember["church_id"]);
									$objChurchName->lstChurch();
									$ChurchName = $objChurchName->dbFetchArray(1);
                ...
                <tr>
                  ...
                  <td><?php echo $ChurchName["church_name"];?></td>
