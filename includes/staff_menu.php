<?php
if($MemberDetail["member_type"]!=1){
$objChurchTop = new Member;
$objChurchTop->setProperty("church_id", $MemberDetail["church_id"]);
$objChurchTop->lstChurch();
$ChurchTop = $objChurchTop->dbFetchArray(1);
}
?>
            <div class="topbar">
                <!-- LOGO -->
                <div class="topbar-left">
                    <div class="text-center">
                        ...
                        <!-- Image Logo here -->
                        <?php if($ChurchTop["church_logo"]!=''){?>
                        <a href="<?php echo SITE_URL;?>" class="logo">
                            <i class="icon-c-logo"> <img src="<?php echo SITE_URL;?>church/<?php echo $ChurchTop["church_logo"]; ?>" height="42"/> </i>
                            <span><img src="<?php echo SITE_URL;?>church/<?php echo $ChurchTop["church_logo"]; ?>" height="65"/></span>
                        </a>
                        <?php } else { ?>
                        <a href="<?php echo SITE_URL;?>" class="logo">
                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone app-search" style="text-align:center;">
                        <h3><?php echo $ChurchTop["church_name"];?></h3>
                            <form role="search" class="" style="display:none;">
